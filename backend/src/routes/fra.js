    ...
    const features = [
      {
        ...
        geometry: { type: 'Polygon', coordinates: [[[73.9, 18.5], [73.912, 18.502], [73.909, 18.511], [73.905, 18.508], [73.898, 18.506], [73.9, 18.5]]] }
      },
      {
        type: 'Feature',
        properties: { id: 'fr1', type: 'forest', state: 'Maharashtra', district: 'Pune' },
        geometry: { type: 'Polygon', coordinates: [[[73.92, 18.52], [73.934, 18.521], [73.931, 18.532], [73.928, 18.534], [73.918, 18.529], [73.922, 18.523], [73.92, 18.52]]] }
      },
      {
        type: 'Feature',
        properties: { id: 'wt1', type: 'water', state: 'Maharashtra', district: 'Pune' },
        geometry: { type: 'Polygon', coordinates: [[[73.94, 18.5], [73.952, 18.501], [73.948, 18.507], [73.942, 18.506], [73.94, 18.5]]] }
      },
      {
        type: 'Feature',
